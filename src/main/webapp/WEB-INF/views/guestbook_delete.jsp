	    ...
	    <div class="row justify-content-center">
	        <div class="col-lg-6">
	            <div class="section_title text-center mb-70">
	                <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">Guestbook Delete</span>
	                <h3 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">방명록 삭제</h3>
	...
	<div class="container">	   
	    <div class="row justify-content-center">
	        <div class="col-lg-6">
	            <div class="section_title text-center mb-70">
	                <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">Guestbook Delete</span>
	                <h3 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">방명록 관리자용 삭제</h3>
	                <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">버튼을 누르시면 아래 방명록이 삭제됩니다</p>
	            </div>
	        </div>
	    </div>
    </div>
