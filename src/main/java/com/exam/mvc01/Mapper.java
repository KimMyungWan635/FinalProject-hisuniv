...
public interface Mapper {
	...
	//검색
	public abstract ArrayList<SearchTO> search(String sContent);
	public abstract String searchLname(String lseq);
	public abstract ArrayList<ScategoryTO> searchSC(String sseq);
